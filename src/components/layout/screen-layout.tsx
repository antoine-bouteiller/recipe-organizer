...
export const ScreenLayout = ({ children, headerEndItem, title, withGoBack }: ScreenLayoutProps) => {
  ...
  return (
    <div
      className={`
        relative flex min-h-0 w-full flex-1 flex-col items-center gap-2
    ...
    >
      ...
      <div
        className={`
          z-10 -mt-10 w-full flex-1 overflow-y-auto rounded-t-3xl bg-background
          md:mt-0 md:max-w-5xl md:overflow-y-visible
        `}
      >
        {children}
      </div>
