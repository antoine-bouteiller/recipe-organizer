...
export const PopoverTrigger = ({ className, children, ...props }: PopoverPrimitive.Trigger.Props): React.ReactElement => (
...
export const PopoverClose = ({ ...props }: PopoverPrimitive.Close.Props): React.ReactElement => (
  <PopoverPrimitive.Close data-slot="popover-close" {...props} />
)

export const PopoverTitle = ({ className, ...props }: PopoverPrimitive.Title.Props): React.ReactElement => (
  <PopoverPrimitive.Title className={cn('font-semibold text-lg leading-none', className)} data-slot="popover-title" {...props} />
)

export const PopoverDescription = ({ className, ...props }: PopoverPrimitive.Description.Props): React.ReactElement => (
