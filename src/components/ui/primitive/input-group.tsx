...
import { Input, type InputProps } from '@/components/ui/primitive/input'
import { Textarea, type TextareaProps } from '@/components/ui/primitive/textarea'
...
export const InputGroup = ({ className, ...props }: React.ComponentProps<'div'>): React.ReactElement => (
  <div
    className={cn(
...
export const InputGroupText = ({ className, ...props }: React.ComponentProps<'span'>): React.ReactElement => (
  <span
    className={cn(
...
export const InputGroupInput = ({ className, ...props }: InputProps): React.ReactElement => <Input className={className} unstyled {...props} />

export const InputGroupTextarea = ({ className, ...props }: TextareaProps): React.ReactElement => (
