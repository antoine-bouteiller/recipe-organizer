...
const Input = ({ className, size = 'default', unstyled = false, ...props }: InputProps) => (
  <span
    className={
      cn(
        !unstyled &&
  ...
  >
    <InputPrimitive
      className={cn(
        ...
        props.type === 'file' && 'text-muted-foreground file:me-3 file:bg-transparent file:text-sm file:font-medium file:text-foreground'
      )}
      data-slot="input"
