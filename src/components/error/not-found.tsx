...
export const NotFound = () => (
  <div class="my-auto flex items-center justify-center bg-background">
    <div class="space-y-8 text-center">
      <div class="flex justify-center">
        <svg class="h-auto w-48" fill="none" height="73" viewBox="0 0 199 73" width="199" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2672_10455" x1="99" x2="99" y1="-16" y2="88">
              <stop stop-color="#D4D4D8" />
              <stop offset="1" stop-color="#E4E4E7" stop-opacity="0.25" />
            </linearGradient>
          </defs>
        </svg>
      </div>
