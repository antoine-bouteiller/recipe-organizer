  ...
  <div className={cn('flex', 'items-center', 'justify-center', 'bg-background', 'my-auto')}>
    <div className={cn('text-center', 'space-y-8')}>
      <div className={cn('flex', 'justify-center')}>
        <svg width="199" height="73" viewBox="0 0 199 73" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn('w-48', 'h-auto')}>
      ...
      <div className={cn('space-y-4')}>
        <h1 className={cn('text-2xl', 'font-semibold', 'text-foreground')}>Page not found</h1>
