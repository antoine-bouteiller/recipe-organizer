import { getSelectDisplay, SelectButton, type SelectButtonProps } from '@client/components/ui/select.shared'
...
const SelectBase = lazy(() => import('@client/components/ui/select.base'))
const SelectDrawer = lazy(() => import('@client/components/ui/select.drawer'))
