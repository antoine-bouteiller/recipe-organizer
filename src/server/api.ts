...
import { ingredientRoutes } from '@server/routes/ingredients/routes'
import { recipeRoutes } from '@server/routes/recipe/routes'
import { shoppingListRoutes } from '@server/routes/shopping-list/routes'
