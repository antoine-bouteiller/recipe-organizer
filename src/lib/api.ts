...
import { ingredientRoutes } from '@/features/ingredients/api/routes'
import { recipeRoutes } from '@/features/recipe/api/routes'
import { shoppingListRoutes } from '@/features/shopping-list/api/routes'
import { userRoutes } from '@/features/users/api/routes'
