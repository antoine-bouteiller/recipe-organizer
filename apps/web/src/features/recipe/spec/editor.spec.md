...
date: 2026-08-14
parent-spec: src/client/features/recipe/spec/index.spec.md
related: [docs/infrastructure/client/forms.spec.md, src/client/features/recipe/spec/crud.spec.md]
---

## 2. Problem Statement

N/A — goals remain owned by `src/client/features/recipe/spec/index.spec.md` [G-3]. This leaf owns the
