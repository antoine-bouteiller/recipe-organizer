...
import * as styles from './search-filter-trigger.css'

/** Private Collapsible trigger: Base UI owns its state, handlers, and ref composition. */
export const SearchFilterTrigger = () => (
  <CollapsiblePrimitive.Trigger aria-label="Filtrer par catégorie" render={<button className={styles.element} type="button" />}>
    <FunnelSimpleIcon />
