...
import { CheckCircleIcon } from '@client/components/icons/check-circle'
import { CircleNotchIcon } from '@client/components/icons/circle-notch'
import { InfoIcon } from '@client/components/icons/info'
import { WarningIcon } from '@client/components/icons/warning'
import { WarningCircleIcon } from '@client/components/icons/warning-circle'
...
const Toasts = ({ position }: { position: ToastPosition }): React.ReactElement => {
...
export const ToastProvider = ({ children, position = 'bottom-right', ...props }: ToastProviderProps): React.ReactElement => (
