...
- **CON-006**: Persisted Zustand store files and their consumers are plain modules — no
...
- **AC-004**: Given a Zustand store, When the file is added under `src/stores/`, Then it is a plain
