...
export const editorChecklist = style({
  listStyleType: 'none',
  paddingInlineStart: 'var(--spacing-0)',
})
...
export const editorContentEditable = style({
  selectors: {
    ...
    '.dark &': {
      backgroundColor: 'color-mix(in oklab, var(--colors-input) 32%, transparent)',
    },
    '&[data-invalid], &[aria-invalid=true]': {
      borderColor: 'color-mix(in oklab, var(--colors-destructive) 36%, transparent)',
    },
